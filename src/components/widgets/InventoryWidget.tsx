...
export const InventoryWidget = React.memo(function InventoryWidget({ className }: InventoryWidgetProps) {
      ...
      actions={
        <div className="flex items-center gap-1">
          <Button
            ...
            className="h-7 w-7"
            aria-label="Import from shopping"
          >
    ...
    >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-0.5 shrink-0">
                    <Button
                      size="icon" variant="ghost"
                      onClick={(e) => { e.stopPropagation(); handleQuickDecrement(item); }}
                      className="h-6 w-6"
                      aria-label="Kurangi"
                    >
      ...
      {showAdd && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40"
          onClick={() => resetForm()}>
          <div className="bg-background rounded-xl p-5 w-80 shadow-lg border"
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <Input value={formUnit} onChange={(e) => setFormUnit(e.target.value)} placeholder="kg, pcs..." />
                </div>
              </div>
              <div>
      ...
      {/* Import Modal */}
      {showImport && <ImportFromShopping onDone={fetchItems} onClose={() => setShowImport(false)} />}
    </WidgetContainer>
  );
});
...
function ImportFromShopping({ onDone, onClose }: { onDone: () => void; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-background rounded-xl p-5 w-80 shadow-lg border max-h-[70vh] flex flex-col"
        onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-semibold flex items-center gap-2">
            <Upload className="h-4 w-4" /> Import dari Shopping
          </h3>
